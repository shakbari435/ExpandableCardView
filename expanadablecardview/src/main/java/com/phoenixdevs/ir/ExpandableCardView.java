...
public class ExpandableCardView extends LinearLayout {
    ...
    private void initView(Context context){
        ...
        inflater.inflate(R.layout.expandable_cardview_fa, this);
    }
    ...
    public void setRtlDirection(){
        ...
        headerIcon.setLayoutParams(params);

        textViewTitle.setGravity(Gravity.LEFT);
        textViewTitle.setPadding(20,5,0,0);
    ...
    public void setOnClickListener(@Nullable OnClickListener l) {
        ...
        if(card != null) card.setOnClickListener(l);
